        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              SizedBox(
                height: headerHeight,
                child: HeaderWidget(headerHeight, true, const Icon(Icons.privacy_tip_outlined, color: Colors.white, size: 100.0)),
              ),
              SafeArea(
                child: Container(
                                ...
                                onPressed: _pinSuccess
                                    ? () {
                                        Navigator.of(context).pushAndRemoveUntil(
                                            MaterialPageRoute(builder: (context) => const ProfilePage()), (Route<dynamic> route) => false);
                                      }
                                    : null,
                                child: Padding(
