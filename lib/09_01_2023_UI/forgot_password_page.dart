...
import 'package:practice/09_01_2023_UI/forgot_password_verification_page.dart';
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              SizedBox(
                height: headerHeight,
                child: HeaderWidget(headerHeight, true, const Icon(Icons.password_rounded, color: Colors.white, size: 100.0)),
              ),
              SafeArea(
                child: Container(
